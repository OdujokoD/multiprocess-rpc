...
pub mod include {
  pub const ID: u64 = 0x95f42c62112b48c8;
  pub fn get_type() -> ::capnp::introspect::Type { <::capnp::text::Owned as ::capnp::introspect::Introspect>::introspect() }
}
pub mod include_types {
  pub const ID: u64 = 0xa9de286363a56a15;
  pub fn get_type() -> ::capnp::introspect::Type { <::capnp::text::Owned as ::capnp::introspect::Introspect>::introspect() }
}
pub mod wrap {
  pub const ID: u64 = 0x98609408f648fd37;
  pub fn get_type() -> ::capnp::introspect::Type { <::capnp::text::Owned as ::capnp::introspect::Introspect>::introspect() }
}
pub mod count {
  pub const ID: u64 = 0xbe2767a03eaddc9f;
  pub fn get_type() -> ::capnp::introspect::Type { <i32 as ::capnp::introspect::Introspect>::introspect() }
}
pub mod exception {
  pub const ID: u64 = 0xd2facf559cc35987;
  pub fn get_type() -> ::capnp::introspect::Type { <::capnp::text::Owned as ::capnp::introspect::Introspect>::introspect() }
}
pub mod name {
  pub const ID: u64 = 0x9018ee90ed142f80;
  pub fn get_type() -> ::capnp::introspect::Type { <::capnp::text::Owned as ::capnp::introspect::Introspect>::introspect() }
}
pub mod skip {
  pub const ID: u64 = 0xe061ba0cf30774be;
...
pub mod thread_map {
  ...
  pub mod _private {
    pub const TYPE_ID: u64 = 0xcbae_59bc_4188_e935;
  }
  ...
  pub mod make_thread_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 34] = [
        ...
        ::capnp::word(191, 107, 143, 125, 172, 180, 194, 239),
      ...
      pub const TYPE_ID: u64 = 0xefc2_b4ac_7d8f_6bbf;
    }
  }
  ...
  pub mod make_thread_results {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 35] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(171, 3, 235, 66, 70, 32, 197, 182),
        ::capnp::word(22, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ...
        ::capnp::word(43, 148, 117, 139, 172, 2, 125, 203),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(17, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub static MEMBERS_BY_NAME : &[u16] = &[0];
      pub const TYPE_ID: u64 = 0xb6c5_2046_42eb_03ab;
    }
  }
}
...
pub mod thread {
  ...
  pub mod _private {
    pub const TYPE_ID: u64 = 0xcb7d_02ac_8b75_942b;
  }
  ...
  pub mod get_name_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 18] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(212, 223, 30, 212, 146, 35, 131, 187),
      ...
      pub const TYPE_ID: u64 = 0xbb83_2392_d41e_dfd4;
    }
  }
  ...
  pub mod get_name_results {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 34] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(242, 229, 70, 153, 8, 3, 254, 232),
        ::capnp::word(19, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub static MEMBERS_BY_NAME : &[u16] = &[0];
      pub const TYPE_ID: u64 = 0xe8fe_0308_9946_e5f2;
    }
  }
}
...
pub mod context {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 57] = [
      ...
      ::capnp::word(46, 177, 47, 160, 247, 209, 116, 206),
      ...
      ::capnp::word(159, 220, 173, 62, 160, 103, 39, 190),
    ...
    pub const TYPE_ID: u64 = 0xb343_1afb_6226_02f6;
  }
}
