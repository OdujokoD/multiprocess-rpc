...
pub mod handler {
  ...
  pub mod _private {
    pub const TYPE_ID: u64 = 0xf784_1228_8c96_26e6;
  }
  ...
  pub mod destroy_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 34] = [
        ...
        ::capnp::word(85, 138, 91, 113, 106, 196, 52, 165),
      ...
      pub const TYPE_ID: u64 = 0xa534_c46a_715b_8a55;
    }
  }
  ...
  pub mod destroy_results {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 18] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(127, 21, 30, 190, 4, 81, 76, 225),
        ::capnp::word(22, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      pub const TYPE_ID: u64 = 0xe14c_5104_be1e_157f;
    }
  }
  ...
  pub mod disconnect_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 34] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(33, 133, 233, 19, 12, 229, 243, 182),
        ::capnp::word(22, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub static MEMBERS_BY_NAME : &[u16] = &[0];
      pub const TYPE_ID: u64 = 0xb6f3_e50c_13e9_8521;
    }
  }
  ...
  pub mod disconnect_results {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 19] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(48, 248, 130, 73, 71, 212, 248, 201),
        ::capnp::word(22, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 7, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub static MEMBERS_BY_NAME : &[u16] = &[];
      pub const TYPE_ID: u64 = 0xc9f8_d447_4982_f830;
    }
  }
}
