...
pub mod echo {
  ...
  pub mod _private {
    pub const TYPE_ID: u64 = 0xa910_a5d6_08bb_1d69;
  }
  ...
  pub mod destroy_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 33] = [
        ...
        ::capnp::word(152, 101, 150, 232, 216, 195, 178, 236),
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(101, 99, 104, 111, 46, 99, 97, 112),
        ::capnp::word(110, 112, 58, 69, 99, 104, 111, 46),
      ...
      pub const TYPE_ID: u64 = 0xecb2_c3d8_e896_6598;
    }
  }
  ...
  pub mod destroy_results {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 17] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(195, 25, 131, 98, 188, 14, 64, 189),
        ::capnp::word(16, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ...
      pub const TYPE_ID: u64 = 0xbd40_0ebc_6283_19c3;
    }
  }
  ...
  pub mod echo_params {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 48] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(91, 55, 206, 229, 19, 26, 216, 151),
        ::capnp::word(16, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ...
        ::capnp::word(101, 99, 104, 111, 46, 99, 97, 112),
        ::capnp::word(110, 112, 58, 69, 99, 104, 111, 46),
        ::capnp::word(101, 99, 104, 111, 36, 80, 97, 114),
      ...
      pub const TYPE_ID: u64 = 0x97d8_1a13_e5ce_375b;
    }
  }
  ...
  pub mod echo_results {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 33] = [
        ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
        ::capnp::word(68, 166, 126, 135, 31, 179, 131, 220),
        ::capnp::word(16, 0, 0, 0, 1, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ...
        ::capnp::word(101, 99, 104, 111, 46, 99, 97, 112),
        ::capnp::word(110, 112, 58, 69, 99, 104, 111, 46),
        ::capnp::word(101, 99, 104, 111, 36, 82, 101, 115),
      ...
      pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
      pub static MEMBERS_BY_NAME : &[u16] = &[0];
      pub const TYPE_ID: u64 = 0xdc83_b31f_877e_a644;
    }
  }
}
