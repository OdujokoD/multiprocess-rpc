...
pub mod block_ref {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 59] = [
      ...
      ::capnp::word(16, 237, 39, 143, 5, 154, 246, 164),
    ...
    pub const TYPE_ID: u64 = 0xf6e4_1d64_765e_a438;
  }
}
...
pub mod bilingual_str {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 61] = [
      ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
      ::capnp::word(40, 83, 178, 226, 154, 214, 214, 237),
    ...
    pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
    pub static MEMBERS_BY_NAME : &[u16] = &[0,1];
    pub const TYPE_ID: u64 = 0xedd6_d69a_e2b2_5328;
  }
}
...
pub mod result { /* Value */
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 51] = [
      ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
      ::capnp::word(46, 32, 236, 126, 73, 137, 110, 144),
      ::capnp::word(13, 0, 0, 0, 1, 0, 0, 0),
      ::capnp::word(16, 237, 39, 143, 5, 154, 246, 164),
      ::capnp::word(2, 0, 7, 0, 0, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0x906e_8949_7eec_202e;
  }
}
...
pub mod result_void { /* Value */
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 36] = [
      ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
      ::capnp::word(81, 247, 146, 48, 94, 223, 233, 170),
      ::capnp::word(13, 0, 0, 0, 1, 0, 0, 0),
      ::capnp::word(16, 237, 39, 143, 5, 154, 246, 164),
      ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 0, 0),
    ...
    pub const TYPE_ID: u64 = 0xaae9_df5e_3092_f751;
  }
}
...
pub mod pair { /* Key,Value */
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 53] = [
      ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
      ::capnp::word(69, 51, 255, 237, 157, 43, 220, 165),
      ::capnp::word(13, 0, 0, 0, 1, 0, 0, 0),
      ::capnp::word(16, 237, 39, 143, 5, 154, 246, 164),
      ::capnp::word(2, 0, 7, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 0, 0),
    ...
    pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
    pub static MEMBERS_BY_NAME : &[u16] = &[0,1];
    pub const TYPE_ID: u64 = 0xa5dc_2b9d_edff_3345;
  }
}
...
pub mod pair_int64 { /* Key */
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 51] = [
      ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
      ::capnp::word(178, 72, 179, 210, 1, 202, 63, 247),
      ::capnp::word(13, 0, 0, 0, 1, 0, 1, 0),
      ::capnp::word(16, 237, 39, 143, 5, 154, 246, 164),
      ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 1, 0, 0, 0),
    ...
    pub static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
    pub static MEMBERS_BY_NAME : &[u16] = &[0,1];
    pub const TYPE_ID: u64 = 0xf73f_ca01_d2b3_48b2;
  }
}
